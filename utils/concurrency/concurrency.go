...
// Repeat return a data of type any chan, put param `values` into the chan repeatedly until cancel the context.
...
// RepeatFn return a chan, executing fn repeatedly, and put the result into returned chan
...
// Take return a chan whose values are taken from another chan
...
// FanIn merge multiple channels into on channel
...
// Tee split on channel into two channels
...
// OrDone read a channel info another channel, will close until cancel context.
