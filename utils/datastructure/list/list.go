...
// ValueOf return the value pointer at index list data
...
// IndexOf return the index of value,if not found return -1
...
// Push append the value to the list data
...
// UpdateAt update value of list at index,index should between 0 and list size -1
...
// Equal compare list to other list,user reflect.DeepEqual
...
// Reverse thr item order of list
...
// Unique remove duplicate item in list
