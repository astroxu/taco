...
// AesCbcEncrypt encrypt data with key use Ars CBC algorithm
// len(key) should be 16,24 or 32
...
// AesCbcDecrypt decrypted data with key use AES CBC algorithm
// len(key) should be 16,24 or 32
...
// AesCtrCrypt encrypt data with key use AES CRT algorithm
// len(key) should be 16,24 or 32
