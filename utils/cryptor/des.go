...
// DesEcbEncrypt encrypt data with use DES ECB algorithm
// len(key) should be 8
...
// DesCfbDecrypt decrypts data with key use DES CFB algorithm
...
// AesOfbDecrypt decrypt data with key use DES OFB algorithm
// len(key) should be 8
